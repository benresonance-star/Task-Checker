export const theme = {
  ...
  components: {
    ...
    dashboard: {
      projectInfoContainer: 'bg-[var(--project-info-bg)] dark:bg-blue-900/10 rounded-project-info border border-[var(--project-info-border)] dark:border-gray-800 mb-8 shadow-sm overflow-hidden',
      ...
      sectionCard: 'space-y-4 border border-[var(--metadata-card-border)] dark:border-gray-800 rounded-metadata p-6 shadow-sm bg-[var(--metadata-card-bg)] dark:bg-transparent',
      ...
      consultantCard: 'bg-[var(--metadata-card-bg)] dark:bg-black/40 rounded-metadata border border-[var(--metadata-card-border)] dark:border-gray-800 p-6 shadow-sm hover:border-google-blue transition-all group/card',
      checklistContainer: 'bg-[var(--checklist-bg)] dark:bg-blue-900/10 rounded-project-info p-4 md:p-12 border border-[var(--checklist-border)] dark:border-gray-800 shadow-sm',
    },
    hierarchy: {
