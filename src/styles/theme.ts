export const theme = {
  ...
  components: {
    ...
    taskGuide: {
      block: 'bg-white dark:bg-black/40 border border-gray-400 dark:border-gray-700 rounded-widget p-6 shadow-sm',
      blockPrereq: 'rounded-widget border-2 p-6 transition-all shadow-sm',
      blockPrereqActive: 'bg-[var(--prereq-bg)] border-[var(--prereq-border)]',
      ...
      inputMaster: 'w-full bg-blue-50/30 dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 rounded-metadata p-4 text-sm font-medium focus:border-google-blue outline-none transition-colors text-gray-800 dark:text-gray-100 resize-y min-h-[6rem] placeholder-gray-400',
      itemPrereq: 'flex items-center justify-between bg-[var(--prereq-item-bg)] px-4 py-3 rounded-metadata border border-[var(--prereq-border)] shadow-sm group',
      itemPrep: 'flex flex-col bg-blue-50/20 dark:bg-black/40 p-4 rounded-metadata border border-blue-100 dark:border-gray-800 shadow-sm group',
    },
    docExplorer: {
    ...
    checklist: {
      ...
      containerInactive: 'bg-white border-[var(--checklist-border)] hover:bg-black/5 dark:hover:bg-white/5',
