export const theme = {
  ...
  components: {
    ...
    hierarchy: {
      ...
      verticalLine: 'absolute bg-gray-300 dark:bg-gray-400 pointer-events-none transition-[height,top] duration-150',
      ...
      horizontalLine: 'absolute -left-[0.5rem] sm:-left-[1.5rem] top-5 sm:top-6 w-[0.5rem] sm:w-[1.5rem] h-[1px] bg-gray-300 dark:bg-gray-400',
