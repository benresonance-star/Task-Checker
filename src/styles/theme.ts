export const theme = {
  ...
  components: {
    ...
    hierarchy: {
      ...
      sectionTitle: 'text-lg sm:text-xl font-black text-gray-600 dark:text-gray-300',
      ...
      subsectionTitle: 'font-black text-gray-600 dark:text-gray-300 text-sm sm:text-lg break-words whitespace-pre-wrap min-w-0 transition-all duration-300',
