export const theme = {
  ...
  components: {
    ...
    hierarchy: {
      section: 'flex items-center gap-2 sm:gap-3 group mb-2 bg-[var(--checklist-bg)] p-1 sm:pl-1.5 sm:pr-5 rounded-card border border-[var(--checklist-border)] transition-all hover:shadow-md',
      ...
      subsection: 'my-1 sm:my-2 bg-[var(--checklist-bg)] rounded-card border border-[var(--checklist-border)] p-1 sm:pl-1.5 sm:pr-5 transition-all hover:shadow-md relative group/sub',
